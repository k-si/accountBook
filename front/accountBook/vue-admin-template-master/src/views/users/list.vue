  ...
  <div class="app-container">
    ...
    <el-form :inline="true" class="demo-form-inline">
      <el-form-item label="nickname:">
        <el-input v-model="searchObj.name" placeholder="your name"/>
      </el-form-item>
    ...
    <el-table
      ...
      <el-table-column prop="intro" label="introduction" align="center"/>
      <el-table-column prop="balance" label="balance" width="150" align="center"/>
      <el-table-column prop="sort" label="sort" width="80" align="center"/>
      <el-table-column prop="gmtCreate" label="add date" width="200" align="center"/>
...
export default {
  ...
  methods: {
    fetchData(page = 1) { // 获取所有用户
      this.page = page
      this.listLoading = true
      users.findByCondition(this.page, this.limit, this.searchObj).then(response => {
